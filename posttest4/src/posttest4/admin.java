...
public class admin extends user {
    ...
    private final String pass = "admin2023";
    ...
    boolean login(String usernameAdm, String passAdm) {
        return this.username.equals(usernameAdm) && this.pass.equals(passAdm);
    }
    ...
    void updateData() {
        ...
        System.out.println("-------------------------------------------");
        System.out.println("\tNama Barang   : " + arrStationary.get(ind).kode);
        System.out.println("\tNama Barang   : " + arrStationary.get(ind).nama);
        System.out.println("\tWarna Barang  : " + arrStationary.get(ind).warna);
        System.out.println("\tJumlah Barang : " + arrStationary.get(ind).harga);
